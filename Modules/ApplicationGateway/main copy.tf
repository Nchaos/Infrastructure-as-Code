resource "azurerm_application_gateway" "this" {
  ...
  dynamic "authentication_certificate" {
    for_each = var.agw_authentication_certificate
    content {
  ...
  dynamic "autoscale_configuration" {
    for_each = var.agw_autoscale_configuration
    content {
  ...
  dynamic "custom_error_configuration" {
    for_each = var.agw_custom_error_configuration
    content {
  ...
  dynamic "frontend_ip_configuration" {
    for_each = var.agw_frontend_ip_configuration
    content {
  ...
  dynamic "frontend_port" {
    for_each = var.agw_frontend_port
    content {
  ...
  dynamic "gateway_ip_configuration" {
    for_each = var.agw_gateway_ip_configuration
    content {
  ...
  dynamic "http_listener" {
    for_each = var.agw_http_listener
    content {
  ...
  dynamic "redirect_configuration" {
    for_each = var.agw_redirect_configuration
    content {
  ...
  dynamic "request_routing_rule" {
    for_each = var.agw_request_routing_rule
    content {
  ...
  dynamic "rewrite_rule_set" {
    for_each = var.agw_rewrite_rule_set
    content {
  ...
  dynamic "ssl_certificate" {
    for_each = var.agw_ssl_certificate
    content {
  ...
  dynamic "trusted_root_certificate" {
    for_each = var.agw_trusted_root_certificate
    content {
  ...
  dynamic "waf_configuration" {
    for_each = var.agw_waf_configuration
    content {
