...
func TestResourceGroup(t *testing.T) {
	...
	resourceGroupIdMap := terraform.Output(t, terraformOptions, "resource_group_id")

	expectedResourceGroupIdMap := string("/subscriptions/d0ce61fb-0b7a-4f0d-9ea2-b1ae691749e0/resourceGroups/rg-dev-tf-val")
