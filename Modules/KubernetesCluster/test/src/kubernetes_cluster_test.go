...
func TestKubernetesCluster(t *testing.T) {
	...
	azureKubernetesClusterIdMap := terraform.Output(t, terraformOptions, "aks_id")

	expectedAzureKubernetesClusterIdMap := string("/subscriptions/d0ce61fb-0b7a-4f0d-9ea2-b1ae691749e0/resourcegroups/rg-dev-val/providers/Microsoft.ContainerService/managedClusters/aks-dev-val")

	// Verify we're getting back the outputs we expect
	require.Equal(t, expectedAzureKubernetesClusterIdMap, azureKubernetesClusterIdMap)
