...
func TestKeyVault(t *testing.T) {
	...
	expectedKeyVaultId := "/subscriptions/d0ce61fb-0b7a-4f0d-9ea2-b1ae691749e0/resourceGroups/rg-dev-kv-val/providers/Microsoft.KeyVault/vaults/akv-dev-val"

	// Verify we're getting back the outputs we expect
	require.Equal(t, expectedKeyVaultId, keyVaultId)
